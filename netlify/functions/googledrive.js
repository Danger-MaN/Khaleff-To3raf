exports.handler = async (event) => {
  ...
  try {
    ...
    // الطريقة الجديدة: استخدام رابط التصدير المباشر مع confirm=t
    // هذا الرابط يعمل داخل عنصر <video> للملفات العامة
    ...
    if (!videoRes.ok) {
      throw new Error(`Drive returned HTTP ${videoRes.status}`);
    }
    ...
    console.log(`Video fetched, size: ${buffer.byteLength} bytes`);
