...
export function MediaRenderer({ url, alt = "", videoAspect = "auto" }: MediaRendererProps) {
  ...
  // الفيديو المباشر - Plyr مع تطبيق بسيط لـ videoAspect
  // نترك Plyr يعمل بشكل طبيعي، ونطبق الـ aspect فقط على عنصر الفيديو
  ...
  if (videoAspect === "portrait") {
    // للفيديو الطولي: نحدد ارتفاع أقصى ونترك العرض يتناسب تلقائياً
    videoStyle.maxHeight = '80vh';
    videoStyle.width = 'auto';
    videoStyle.margin = '0 auto';
  }
